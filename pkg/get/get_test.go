...
func Test_DownloadEKSCTLANYWHERE(t *testing.T) {
	...
	tests := []test{
		{os: "linux",
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://github.com/aws/eks-anywhere/releases/download/v0.12.0/eksctl-anywhere-v0.12.1-linux-amd64.tar.gz"},
		{os: "darwin",
			arch:    arch64bit,
			version: toolVersion,
			url:     "https://github.com/aws/eks-anywhere/releases/download/v0.12.0/eksctl-anywhere-v0.12.1-darwin-amd64.tar.gz"},
	}
